...
from akf_accounts.akf_accounts.doctype.cost_center.is_internal_branch import (
    process_internal_branch_struct,
    delete_supplier_and_customer
)
...
class CostCenter(NestedSet):
	...
	def validate(self):
		...
		if(not self.is_new()): process_internal_branch_struct(self)
	...
	def after_insert(self):
		process_internal_branch_struct(self)
