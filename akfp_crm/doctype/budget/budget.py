...
from akf_accounts.utils.encumbrance.enc_budget import (
	validate_donor_balance,
	make_project_encumbrance_gl_entries,
	cancel_project_encumbrance_gl_entries
)
...
class Budget(Document):
	...
	def set_null_value(self):
		if self.budget_against == "Cost Center":
			self.project = None
		elif(not self.encumbrance): # Nabeel Saleem, 26-02-2025
	...
	def on_submit(self):
		make_project_encumbrance_gl_entries(self)
	
	def on_cancel(self):
		cancel_project_encumbrance_gl_entries(self)
